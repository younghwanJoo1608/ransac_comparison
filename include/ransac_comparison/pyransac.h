                ...
                )
{
    for (int i = 0; i < max_iteration; i++)
    {
        ...
        random.setSample((unsigned int)(6));
        ...
        Eigen::Vector3f pt1((*pt_samples).at(0).x,
                            (*pt_samples).at(0).y,
                            (*pt_samples).at(0).z);
        Eigen::Vector3f pt2((*pt_samples).at(1).x,
                            (*pt_samples).at(1).y,
                            (*pt_samples).at(1).z);
        Eigen::Vector3f pt3((*pt_samples).at(2).x,
                            (*pt_samples).at(2).y,
                            (*pt_samples).at(2).z);
        ...
        Eigen::Vector3f pt4((*pt_samples).at(3).x,
                            (*pt_samples).at(3).y,
                            (*pt_samples).at(3).z);
        ...
        Eigen::Vector3f pt5((*pt_samples).at(4).x,
                            (*pt_samples).at(4).y,
                            (*pt_samples).at(4).z);
        ...
        Eigen::Vector3f pt6((*pt_samples).at(5).x,
                            (*pt_samples).at(5).y,
                            (*pt_samples).at(5).z);
